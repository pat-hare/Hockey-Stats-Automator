...
def createInDepthTable(home, away):
    ...
    data[home.team.teamName].append(home.pp_metrics_fg['ce']/home.pp_metrics_fg['total'])
    ...
    data[away.team.teamName].append(away.pp_metrics_fg['ce']/away.pp_metrics_fg['total'])
