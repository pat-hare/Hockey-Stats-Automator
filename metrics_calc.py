...
def calcMetrics(metrics, pp_metrics):
    ...
    metrics['oEff'] = (metrics['pp_win'] + pp_metrics['pp_win']) * 2 + (sum(metrics['25e'].values())) * 2 + (totalCE + pp_metrics['ce']) * 4 + (metrics['gso'] + pp_metrics['gso']) * 6 + (metrics['pc_win'] + pp_metrics['pc_win']) * 6 + (metrics['goals'] + pp_metrics['goals']) * 10 - metrics['lost'] - pp_metrics['lost']

    metrics['25Eff'] = (metrics['pp_win'] + pp_metrics['pp_win']) + (totalCE + pp_metrics['ce']) * 3 + (metrics['gso'] + pp_metrics['gso']) * 6 + (metrics['pc_win'] + pp_metrics['pc_win']) * 6 + (metrics['goals'] + pp_metrics['goals']) * 10 - metrics['lost'] - pp_metrics['lost']
